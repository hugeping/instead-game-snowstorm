...
room {
	...
	dsc = [[Это действительно твоя комната. Комната, в которую ты покинула ещё совсем недавно. Перед тем... как вы уехали с мамой...^^
Ты видишь те же: стол, шкаф, кровать и книжные полки... И даже окно! Правда, мебель стоит неправильно и на стене нет зеркала. Интересно, куда оно подевалось?]];
	out_to = 'Тронный зал';
}:with {
	'дверь';
	obj {
...
Не сразу, но все-таки ты сообразила, что слова написаны наоборот. С трудом ты прочитала следующее:^]];
	...
	obj {
		...
		description = [[В окне ты видишь пустынный белый пейзаж.]];
...
Ты даже боишься представить сколько их может быть здесь, в этом громадном зале.]];
		before_Search = function(s)
			...
			local t = {
				...
				[[Ты видишь салон легковой машины. На заднем сидении сидит мальчик с грустными глазами.]];
			}
			pn(t[rnd(#t)])
	...
	obj {
		-"снежинки";
		description = [[Интересно, откуда здесь снег?]];
	}:attr'scenery';
	obj {
		-"всполохи|сияние";
