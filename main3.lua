...
напряжение кристалла достигает своего пика. И, наконец, он шумно взрывается на мелкие осколки.]]
	...
	obj {
		...
		['before_Attack,Knock'] = function(s)
			...
			if s.try == 0 then
				s.try = 1
				p [[Ответом был глухой звук. Интересно, они все одинаковые?]]
			elseif s.try == 1 then
...
room {
	...
	dsc = function(s)
		p [[Это действительно твоя комната. Комната, в которую ты покинула ещё совсем недавно. Перед тем... как вы уехали с мамой...^^
Ты видишь те же: стол, шкаф, кровать и книжные полки... И даже окно!]];
	...
	['s_to,d_to,out_to']= 'Тронный зал';
}:with {
	'дверь';
	obj {
		-"книжные полки/жр,мн|полки/мн,жр|полка/жр";
		description = function(s)
			p "Полки висят на стене прямо над столом. Они завалены школьными учебниками и тетрадками.";
...
череду зеркал, но так ничего и не обнаружила. Разочарованная, ты вернулась к лестнице.]]
	...
	cant_go = function(s)
		p [[Ты можешь плутать по залу вечность. Ты раздавлена его масштабами и не видишь смысла искать здесь что-нибудь кроме пустоты.]]
	end;
	enter = function(s, f)
...
Опасный и долгий спуск по скользким ступенькам занял продолжительное время и открыл твоему взору грандиозный вид.]]
	...
	dsc = [[Ты находишься громадном зале. Ты даже боишься представить его размеры. Километры ледяных стен подсвеченные всполохами полярных сияний.
...
cutscene {
	...
	title = false;
	text = {
		[[Ты берёшь в руки скрипку и извлекаешь первые звуки.^^
		Отчаяние ещё душит тебя. Но постепенно под натиском музыки оно отступает.^^
		Звуки скрипки заполняют комнату.^^
		Ты чувствуешь как они проходят сквозь стены, уносятся вверх, спускаются глубоко вниз. Проникают в каждый уголок ледяного замка...^^
		-- Дрянь! Дрянь! Дрянь! -- искорёженный ненавистью голос раздаётся в комнате.^^
...
obj {
	...
	['before_Attack,Take'] = function(s)
		p [[Ты берёшь зеркало в руки и с размаху бросаешь на пол. Сотни мелких осколков разлетается по всей комнате.^^
