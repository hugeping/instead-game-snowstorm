...
-- Я сделала то, что мне повелела госпожа.]];
		...
		before_Exam = function(s)
			p [[Тебе кажется, что это полярная сова. На месте глаз у совы две зияющие дырки.]];
			if not s.seen then
...
cutscene {
	...
	text = {
		...
		[[Вы мчитесь по лесу на запад. Снова и снова олень огибает встречные деревья и вы оставляете их позади.]];
...
cutscene {
	...
	text = {
		[[Ты садишься на оленя и он поднимается с колен.]];
		[[Вы мчитесь по лесу на восток. Снова и снова олень огибает встречные деревья и вы оставляете их позади.]];
...
Area {
	nam = 'Ледяные горы';
	title = 'У ледяных гор';
	dsc = [[Ты стоишь перед ледяной стеной. На востоке начинается лес.]];
