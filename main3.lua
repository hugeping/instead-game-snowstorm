...
obj {
	...
	before_Exam = function(s)
		p [[Этот детский браслет мама подарила тебе на Рождество, когда тебе было 10 лет.
...
room {
	...
	dsc = [[Ты находишься в огромном зале. В центре зала установлен трон. Все пространство зала залито светом, который отражается
от ледяных стен, пола, потолка и массивных колонн.]];
	['out_to,e_to'] = 'У замка';
}:with {
	obj {
		-"трон|кресло";
...
dlg {
...
}: with {
	{
		'#дальше';
		{
			...
			'-- Ну зачем ты так? Ты стала такой грубой!';
			{
				'Хватит претворяться! Ты не моя мама!';
		...
		'#дальше2';
		{
			...
			[[-- Хорошо, дитя. Жаль, что тебе нужно время, чтобы привыкнуть ко мне. Но я подожду. Мой слуга проводит тебя в твою комнату.]];
			{
				...
				[[-- Глупышка, ты думаешь я тебя обманываю? Знай, ты свободна ходить туда, куда хочешь. И делать то, что хочешь. Можешь искать свою... {$fmt em|другую} маму. Но не отказывай мне, посмотри свою комнату. Отдохни. И приходи ко мне, когда забудешь о своих фантазиях.]];
				{
					...
					{
						[[Похоже, у меня нет выбора. Я в твоей власти?]];
						function(s)
...
cutscene {
	...
	title = 'Конец';
	text = {
		[[Ты поднимаешься по ступенькам педьестала и обнимаешь свою мать.]];
