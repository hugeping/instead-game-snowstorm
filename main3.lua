...
room {
	...
	title = 'Плато';
	-"плато/ср";
	dsc = [[Ты находишься на снежном плато, рядом со входом в пещеру. Ледяные горы окружают плато со всех сторон. Может быть поэтому, стоит мёртвая тишина. В центре плато стоит ледяной замок.]];
	in_to = 'отверстие';
	e_to = 'отверстие';
}: with {
	'отверстие';
