...
room {
	...
	enter = function(s)
		if s:once() then
			...
			pn [[-- Я ждала тебя! Подойди же, обними и поцелуй меня! -- спокойный голос матери показался тебе чужим.]]
		end
	end;
...
от ледяных стен, пола, потолка и массивных колонн.]];
	...
	obj {
		...
		before_Walk = function(s)
			...
			p [[Ты бежишь к трону. Твоё сердце готово выпрыгнуть из груди. Но что-то странное ты замечаешь в облике матери.
